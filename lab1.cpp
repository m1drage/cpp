 ...
 *
 * Пользователь вводит 10 целых чисел, которые сохраняются в массив.
 *
 ...
 *
 * Пользователь вводит индексы двух элементов, после чего их значения меняются местами.
 *
 * @param arr Массив из 10 элементов.
 */
 ...
 *
 * Изменяет значения элементов массива и выводит полученный массив на экран.
 *
 * @param arr Массив из 10 элементов.
 */
 ...
 *
 * Заполняет массив, выводит его, меняет местами два элемента, а затем умножает все элементы на 2.
 *
