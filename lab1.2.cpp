 ...
 *
 * Находит первый отрицательный элемент, удаляет его и все последующие элементы.
 ...
 *
 * Считывает размер и элементы динамического массива, вызывает функцию обработки и выводит результат.
